...
//In welcher Umgebung befindet sich das Projekt, wo wird Ubuntu installiert, was kann von von wo aus steuern; HMI als Schnittstelle
//tiefer auf technische Randbedingungen eingehen
...
//https://github.com/ApolloAuto/apollo/tree/master/docker/build
//läuft auf CyberRT (siehe Handskizze), Entwicklung auf dev
