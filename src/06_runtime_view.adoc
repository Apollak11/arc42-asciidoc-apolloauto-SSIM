...
Dies geschiet in Planning. Das Modul verwendet dafür die Kartendaten aus Map, die Umgebungsaufnahme aus Perceiption und die festgestellte Fahrzeugposition aus Localization.
