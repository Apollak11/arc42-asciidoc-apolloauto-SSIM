...
//https://github.com/ApolloAuto/apollo/blob/r5.5.0/docs/FAQs/General_FAQs.md
//https://github.com/ApolloAuto/apollo/blob/r5.5.0/docs/FAQs/Software_FAQs.md
[role="arc42help"]

Dieser Abschnitt enthält die Qualitätsanforderungen als Qualitätsbaum mit Szenarien.

//siehe Skizze_Vorlage
